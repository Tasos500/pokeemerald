...
{
    [MOVE_NONE] = _("-"),
    [MOVE_POUND] = _("ΧΤΥΠΗΜΑ"),
    [MOVE_KARATE_CHOP] = _("ΚΑΡΑΤΙΑ"),
    [MOVE_DOUBLE_SLAP] = _("ΔΙΠΛΗ ΦΑΠΑ"),
    [MOVE_COMET_PUNCH] = _("ΓΡΟΝΘΟΚΟΠΗΜΑ"),
    [MOVE_MEGA_PUNCH] = _("ΜΕΓΑ ΓΡΟΘΙΑ"),
    [MOVE_PAY_DAY] = _("ΠΛΗΡΩΜΗ"),
    [MOVE_FIRE_PUNCH] = _("ΠΥΡΟΓΡΟΘΙΑ"),
    [MOVE_ICE_PUNCH] = _("ΠΑΓΟΓΡΟΘΙΑ"),
    [MOVE_THUNDER_PUNCH] = _("ΚΕΡΑΥΝΟΓΡΟΘΙΑ"),
    [MOVE_SCRATCH] = _("ΓΡΑΤΖΟΥΝΙΑ"),
    [MOVE_VICE_GRIP] = _("ΛΑΒΗ ΜΕΓΓΕΝΗ"),
    [MOVE_GUILLOTINE] = _("ΓΚΙΛΟΤΊΝΑ"),
    [MOVE_RAZOR_WIND] = _("ΑΝΕΜΟΣΞΥΡΑΦΙ"),
    [MOVE_SWORDS_DANCE] = _("ΧΟΡΟΣ ΞΙΦΩΝ"),
    [MOVE_CUT] = _("ΚΟΨΙΜΟ"),
    [MOVE_GUST] = _("ΡΙΠΗ"),
    [MOVE_WING_ATTACK] = _("ΧΤΥΠΗΜΑΦΤΕΡΟΥ"),
    [MOVE_WHIRLWIND] = _("ΣΤΡΟΒΙΛΟΣ"),
    [MOVE_FLY] = _("ΠΤΗΣΗ"),
    [MOVE_BIND] = _("ΔΕΣΜΕΥΣΗ"),
    [MOVE_SLAM] = _("ΚΟΠΑΝΙΣΜΑ"),
    [MOVE_VINE_WHIP] = _("ΚΛΗΜΑΜΑΣΤΙΓΙΟ"),
    [MOVE_STOMP] = _("ΠΟΔΟΠΑΤΗΜΑ"),
    [MOVE_DOUBLE_KICK] = _("ΔΙΠΛΗ ΚΛΩΤΣΙΑ"),
    [MOVE_MEGA_KICK] = _("ΜΕΓΑ ΚΛΩΤΣΙΑ"),
    [MOVE_JUMP_KICK] = _("ΚΛΩΤΣΙΑΠΤΩΣΗΣ"),
    [MOVE_ROLLING_KICK] = _("ΚΥΚΛ.ΚΛΩΤΣΙΑ"),
    [MOVE_SAND_ATTACK] = _("ΡΙΨΗ ΑΜΜΟΥ"),
    [MOVE_HEADBUTT] = _("ΚΕΦΑΛΙΑ"),
    [MOVE_HORN_ATTACK] = _("ΜΥΤΕΡΟΚΕΡΑΤΟ"),
    [MOVE_FURY_ATTACK] = _("ΧΤΥΠΗΜΑ ΟΡΓΗΣ"),
    [MOVE_HORN_DRILL] = _("ΚΕΡΑΤΟΤΡΥΠΑΝΙ"),
    [MOVE_TACKLE] = _("ΤΑΚΛΙΝ"),
    [MOVE_BODY_SLAM] = _("ΚΑΤΑΠΛΑΚΩΣΗ"),
    [MOVE_WRAP] = _("ΤΥΛΙΓΜΑ"),
    [MOVE_TAKE_DOWN] = _("ΕΦΟΔΟΣ"),
    [MOVE_THRASH] = _("ΞΥΛΟΚΟΠΗΜΑ"),
    [MOVE_DOUBLE_EDGE] = _("ΔΙΚΟΠΟΜΑΧΑΙΡΙ"),
    [MOVE_TAIL_WHIP] = _("ΚΟΥΝΗΜΑ ΟΥΡΑΣ"),
    [MOVE_POISON_STING] = _("ΔΗΛΗΤ.ΚΕΝΤΡΙ"),
    [MOVE_TWINEEDLE] = _("ΔΙΠΛΗ ΒΕΛΟΝΑ"),
    [MOVE_PIN_MISSILE] = _("ΚΑΡΦΙΑΒΛΗΜΑΤΑ"),
    [MOVE_LEER] = _("ΛΟΞΟ ΒΛΕΜΜΑ"),
    [MOVE_BITE] = _("ΔΑΓΚΩΝΙΑ"),
    [MOVE_GROWL] = _("ΓΡΥΛΙΣΜΑ"),
    [MOVE_ROAR] = _("ΚΡΑΥΓΗ"),
    [MOVE_SING] = _("ΤΡΑΓΟΥΔΙ"),
    [MOVE_SUPERSONIC] = _("ΥΠΕΡΗΧΟΣ"),
    [MOVE_SONIC_BOOM] = _("ΘΡΑΥΣΗ ΗΧΟΥ"),
    [MOVE_DISABLE] = _("ΑΝΑΣΤΟΛΗ"),
    [MOVE_ACID] = _("ΟΞΥ"),
    [MOVE_EMBER] = _("ΣΠΙΘΕΣ"),
    [MOVE_FLAMETHROWER] = _("ΦΛΟΓΟΒΟΛΟ"),
    [MOVE_MIST] = _("ΟΜΙΧΛΗ"),
    [MOVE_WATER_GUN] = _("ΝΕΡΟΠΙΣΤΟΛΟ"),
    [MOVE_HYDRO_PUMP] = _("ΑΝΤΛΙΑ ΝΕΡΟΥ"),
    [MOVE_SURF] = _("ΣΕΡΦΑΡΙΣΜΑ"),
    [MOVE_ICE_BEAM] = _("ΑΚΤΙΝΑ ΠΑΓΟΥ"),
    [MOVE_BLIZZARD] = _("ΠΑΓΕΤΩΝΑΣ"),
    [MOVE_PSYBEAM] = _("ΨΥΧΟΡΙΠΗ"),
    [MOVE_BUBBLE_BEAM] = _("ΑΚΤΙΝΑΦΟΥΣΚΑΣ"),
    [MOVE_AURORA_BEAM] = _("ΑΚΤΙΝΑΣΕΛΑΤΟΣ"),
    [MOVE_HYPER_BEAM] = _("ΥΠΕΡΑΚΤΙΝΑ"),
    [MOVE_PECK] = _("ΤΣΙΜΠΗΜΑ"),
    [MOVE_DRILL_PECK] = _("ΡΑΜΦΟΣΤΡΥΠΑΝΙ"),
