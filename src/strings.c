...
const u8 gText_ExpandedPlaceholder_Article_Male[] = _("Ο");
const u8 gText_ExpandedPlaceholder_Article_Male_Lower[] = _("ο");
const u8 gText_ExpandedPlaceholder_Article_Female[] = _("Η");
const u8 gText_ExpandedPlaceholder_Article_Female_Lower[] = _("η");
const u8 gText_ExpandedPlaceholder_Adjective_Male[] = _("ος");
const u8 gText_ExpandedPlaceholder_Adjective_Female[] = _("η");
const u8 gText_ExpandedPlaceholder_Adjective_Male_Tonos[] = _("ός");
const u8 gText_ExpandedPlaceholder_Adjective_Female_Tonos[] = _("ή");
const u8 gText_ExpandedPlaceholder_Genitive_Male[] = _("ου");
const u8 gText_ExpandedPlaceholder_Genitive_Female[] = _("ης");
const u8 gText_ExpandedPlaceholder_Genitive_Male_Cap[] = _("ΟΥ");
const u8 gText_ExpandedPlaceholder_Genitive_Female_Cap[] = _("ΗΣ");
const u8 gText_ExpandedPlaceholder_Trainer_Male[] = _("ΕΚΠΑΙΔΕΥΤΗΣ");
const u8 gText_ExpandedPlaceholder_Trainer_Female[] = _("ΕΚΠΑΙΔΕΥΤΡΙΑ");
const u8 gText_ExpandedPlaceholder_Rival_Ending_Ni[] = _("ν");
const u8 gText_ExpandedPlaceholder_Honey_Male[] = _("γλυκέ");
const u8 gText_ExpandedPlaceholder_Honey_Female[] = _("γλυκιά");
...
const u8 gText_EggNickname[] = _("ΑΒΓΟ");
const u8 gText_Pokemon[] = _("POKéMON");
const u8 gText_ProfBirchMatchCallName[] = _("ΚΑΘ. BIRCH");
const u8 gText_MainMenuNewGame[] = _("ΝΕΟ ΠΑΙΧΝΙΔΙ");
const u8 gText_MainMenuContinue[] = _("ΣΥΝΕΧΕΙΑ");
const u8 gText_MainMenuOption[] = _("ΕΠΙΛΟΓΕΣ");
const u8 gText_MainMenuMysteryGift[] = _("ΜΥΣΤΗΡΙΟ ΔΩΡΟ");
const u8 gText_MainMenuMysteryGift2[] = _("ΜΥΣΤΗΡΙΟ ΔΩΡΟ");
const u8 gText_MainMenuMysteryEvents[] = _("ΜΥΣΤΗΡΙΟ ΣΥΜΒΑΝ");
const u8 gText_WirelessNotConnected[] = _("Ο Ασύρματος Αντάπτορας δεν\nείναι συνδεδεμένος.");
const u8 gText_MysteryGiftCantUse[] = _("Το ΜΥΣΤΗΡΙΟ ΔΩΡΟ δεν χρησιμοποιείται\nμε τον Ασύρματο Αντάπτορα.");
const u8 gText_MysteryEventsCantUse[] = _("Το ΜΥΣΤΗΡΙΟ ΣΥΜΒΑΝ δεν χρησιμοποιείται\nμε τον Ασύρματο Αντάπτορα.");
...
const u8 gText_SaveFileCorrupted[] = _("Το αρχείο έχει φθαρεί. Το\nπροηγούμενο αρχείο θα φορτωθεί.");
const u8 gText_SaveFileErased[] = _("Το αρχείο έχει διαγραφεί λόγω\nφθοράς ή ζημιάς.");
const u8 gJPText_No1MSubCircuit[] = _("1Mサブきばんが ささっていません！");
const u8 gText_BatteryRunDry[] = _("Η εσωτερική μπαταρία είναι άδεια.\nΤο παιχνίδι λειτουργεί κανονικά.\pΌμως, συμβάντα με βάση το\nρολόι δεν θα συμβούν ξανά.");
const u8 gText_Player[] = _("PLAYER"); // Unused
const u8 gText_Pokedex[] = _("POKéDEX"); // Unused
const u8 gText_Time[] = _("ΧΡΟΝΟΣ");
...
ALIGNED(4) const u8 gText_PickNextCancel[] = _("{DPAD_UPDOWN}ΕΠΙΛΕΞΕ {A_BUTTON}ΕΠΟΜΕΝΟ {B_BUTTON}ΑΚΥΡΟ");
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}ΕΠΙΛΟΓΗ {A_BUTTON}{B_BUTTON}ΑΚΥΡΟ");
ALIGNED(4) const u8 gText_AButtonExit[] = _("{A_BUTTON}ΕΞΟΔΟΣ");
const u8 gText_BirchBoy[] = _("ΑΓΟΡΙ");
const u8 gText_BirchGirl[] = _("ΚΟΡΙΤΣΙ");
...
const u8 gText_ThisIsAPokemon[] = _("Αυτό εδώ είναι που αποκαλούμε\n“POKéMON.”{PAUSE 96}\p");
...
const u8 gText_EmptyWeight[] = _("        .   λβρ."); // Unused
const u8 gText_EmptyPokedexInfo1[] = _(""); // Unused
const u8 gText_CryOf[] = _("ΚΑΛΕΣΜΑ");
const u8 gText_EmptyPokedexInfo2[] = _(""); // Unused
const u8 gText_SizeComparedTo[] = _("ΜΕΓΕΘΟΣ ΒΑΣΕΙ ΤΟΥ ");
const u8 gText_PokedexRegistration[] = _("Η εγγραφή στην POKéDEX ολοκληρώθηκε.");
const u8 gText_HTHeight[] = _("ΥΨΟΣ");
const u8 gText_WTWeight[] = _("ΒΑΡΟΣ");
const u8 gText_SearchingPleaseWait[] = _("Αναζήτηση…\nΠαρακαλώ περιμένετε.");
const u8 gText_SearchCompleted[] = _("Αναζήτηση ολοκληρώθηκε.");
const u8 gText_NoMatchingPkmnWereFound[] = _("Δεν βρέθηκαν POKéMON.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Αναζήτηση POKéMON βάσει\nεπιλεγμένων παραμέτρων.");
const u8 gText_SwitchPokedexListings[] = _("Switch POKéDEX listings.");
const u8 gText_ReturnToPokedex[] = _("Επιστροφή στην POKéDEX.");
const u8 gText_SelectPokedexMode[] = _("Επιλέξτε λειτουργία POKéDEX.");
...
const u8 gText_DexNatTitle[] = _("ΕΘΝΙΚΗ DEX");
...
const u8 gText_DexSearchColorRed[] = _("ΚΟΚΚΙΝΟ");
const u8 gText_DexSearchColorBlue[] = _("ΜΠΛΕ");
const u8 gText_DexSearchColorYellow[] = _("ΚΙΤΡΙΝΟ");
const u8 gText_DexSearchColorGreen[] = _("ΠΡΑΣΙΝΟ");
const u8 gText_DexSearchColorBlack[] = _("ΜΑΥΡΟ");
const u8 gText_DexSearchColorBrown[] = _("ΚΑΦΕ");
const u8 gText_DexSearchColorPurple[] = _("ΜΩΒ");
const u8 gText_DexSearchColorGray[] = _("ΓΚΡΙ");
const u8 gText_DexSearchColorWhite[] = _("ΛΕΥΚΟ");
const u8 gText_DexSearchColorPink[] = _("ΡΟΖ");
const u8 gText_DexHoennDescription[] = _("Η τοπική POKéDEX της\nHOENN.");
const u8 gText_DexNatDescription[] = _("Η εθνική έκδοση της\nPOKéDEX");
